<x-auth-layout>
    ...
    <div class="page-body">
                        ...
                        <div class="card-body">
                            <div class="title-header option-title">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    <a href="{{ route('admin.all.addsubtitle') }}" class="align-items-center btn btn-theme d-flex">
                                    ...
                                    <table class="table all-package theme-table" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <a href='' data-bs-t="modal" data-bs-target="#categoryModal{{ $list->categoryId }}">
                                                ...
                                                <td data-label="タイトル" style="font-size: 14px;">
                                                    <div style="vertical-align: middle;">
                                                        ...
                                                        <a href='' data-bs-toggle="modal" data-bs-target="#categoryModal{{ $list->categoryId }}">
                                                            <i class="ri-pencil-line"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td data-label="タイトル" style="font-size: 14px;">
                                                    <div style="vertical-align: middle;">
                                                        ...
                                                        <a href='' data-bs-toggle="modal" data-bs-target="#subTitleModal{{ $list->subCatTitleId }}">
                                                            <i class="ri-pencil-line"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#deleteConfirmModal{{ $id . $type }}">
                                                                <i class="ri-delete-bin-line"></i>
                                                            </a>
                                                            @endif
                                                        </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="POST" action="{{ route('deletecategory') }}" style="display:flex;">
                            ...
                            <button type="submit" class="btn btn-animation btn-md fw-bold me-2" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Yes</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="commission-form{{ $list->categoryId }}" method="POST" action="{{ route('updatecategory_Name') }}" style="display:flex;">
                    @csrf
                    <div class="modal-body">

                        <div class="form-group">
                            <input type="text" class="form-control" id="category{{ $list->categoryId }}" value="{{ old('category') ?? ($list->category ?? '') }}" name="category" placeholder={{ $list->category }}>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" id="category-id{{ $list->categoryId }}" name="categoryid" value="{{ $list->categoryId }}">
                ...
                <button type="button" class="btn btn-animation btn-md fw-bold me-2" data-bs-dismiss="modal" style="background-color: #ff6b6b;border-color: #ff6b6b;">Cancel</button>
    ...
    @endforeach --}}
    @foreach ($lists as $key => $list)
    <div class="modal fade theme-modal remove-commission" id="categoryModal{{ $list->categoryId }}" aria-hidden="true" aria-labelledby="subTitleModalLabel{{ $list->categoryId }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
    ...
    <div class="modal fade theme-modal remove-commission" id="subTitleModal{{ $list->subCatTitleId }}" aria-hidden="true" aria-labelledby="subTitleModalLabel{{ $list->subCatTitleId }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form method="POST" action="{{ route('updatesubcat_Name') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="subcat{{ $list->subCatTitleId }}" value="{{ old('subcat') ?? ($list->sub_category_titlename ?? '') }}" name="subcat" placeholder={{ $list->sub_category_titlename }}>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" id="subcat-id{{ $list->subCatTitleId }}" name="subcatid" value="{{ $list->subCatTitleId }}">
