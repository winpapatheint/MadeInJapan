...
<body>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="{{ url('/product-left-thumbnail') }}" class="drop-image">
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ url('/product-circle') }}l">Product Tab</a>
                                                                <a class="dropdown-item"
                                            ...
                                            <li class="nav-item dropdown new-nav-item">
                                                ...
                                                <ul class="dropdown-menu">
                                                <li>
                                                        <a class="dropdown-item" href="{{ url('/contact-us') }}">Contact</a>
                                                    </li>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url('/seller-grid') }}">Seller Grid</a>
                                                    </li>
    ...
    <section class="vendor-breadcrumb-section">
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="theme-setting-button color-picker">
                                <form class="form-control">
                                    ...
                                    <input type="color" class="form-control form-control-color" id="colorPick"
                                        value="#355AB1" title="Choose your color">
                                </form>
                            </div>
                        </li>
