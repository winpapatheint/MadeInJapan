...
<head>
    ...
    <meta name="description"
        content="Made In Japan admin is super flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
    <meta name="keywords"
            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="{{ route('seller.dashboard') }}">
                            <img class="img-fluid main-logo"
                                src="{{ asset('backend/assets/images/logo/mijapan.png') }}" alt="logo">
                    ...
                    <div class="toggle-sidebar">
                        ...
                        <a href="{{ route('seller.dashboard') }}">
                            <img src="{{ asset('backend/assets/images/logo/mijapan.png') }}" class="img-fluid"
                                alt="">
                        </a>
                    </div>
                </div>
