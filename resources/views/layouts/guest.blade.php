                        ...
                        <ul class="about-list right-nav-about">
                            <li class="right-nav-list">
                                <div class="dropdown theme-form-select" style="display: flex;">
                                    <img src="{{ asset('frontend/assets/images/country/japan.png') }}" class="img-fluid blur-up lazyload" alt="" width="30px">
                                    <img src="{{ asset('frontend/assets/images/country/united-states.png') }}" class="img-fluid blur-up lazyload" alt="" width="30px" style="margin-left: 5px;">
                                </div>
                            </li>
                            <li class="right-nav-list">
                                ...
                                <ul class="right-side-menu">
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="{{ route('show-product-left-thumbnail', ['id' => $cart->product_id]) }}">
                                                                <img src="{{ asset('images/' . $cart->product_thambnail) }}" class="blur-up lazyload" alt="" width="87" height="73">
                                                            </a>
                                    ...
                                    <li class="profile-nav onhover-dropdown pe-0 me-0">
                                        ...
                                        <div class="media profile-media">
                                            <img src="{{ !empty(Auth::user()->user_photo) ? url('upload/profile/' . Auth::user()->user_photo) : url('backend/assets/images/users/4.jpg') }}" class="user-profile rounded-circle" width="30px" height="30px">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown dropdown-mega">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-2">
                                                    ...
                                                    @foreach ($category->subCategoryTitle as $index =>
                                                    $subCategoryTitle)
                                                    @if ($index % 3 == 0)
                                                    @if ($index > 1)
                                                    <div class="row" style="margin-top: 10px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="dropdown-column col-xl-3">
                                                                ...
                                                                @foreach ($subCategoryTitle->subCategory as
                                                                $subCategory)
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="{{ route('show-product-left-thumbnail', ['id' => $list->id]) }}" class="deal-image">
                                        <img src="{{ asset('images/' . $list->product_thambnail) }}" class="blur-up lazyload" alt="">
                                    </a>
                        ...
                        <li>
                            ...
                            <div class="theme-setting-button color-picker">
                                <form class="form-control">
                                    ...
                                    <input type="color" class="form-control form-control-color" id="colorPick" value="#417394" title="Choose your color">
                                </form>
                            </div>
                        </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="POST" action="{{ route('adminlogout') }}">
                        @csrf
                        <button type="submit" class="btn btn-animation btn-md fw-bold" style="background: #417394; !important;">Yes</button>
                    </form>
